...
main: {
	...
	grid: {
		...
		add_webarena: "Add a new virtual board to this work package.",
		add_webarena_title: 'Create virtual board',
...
dialog: {
	...
	webarena: {
		fieldLabel:'Heading of the virtual board',
		title_1: 'New virtual board in',
		title_2: 'Create',
		button_add: 'Create virtual board.'
	},
	htmlTextNew: {
